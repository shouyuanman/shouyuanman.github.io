...
![Desktop View](/assets/images/20241208/onlineddl_mysql_version.jpg){: width="500" height="300" }
_MySQL数据库版本_

>想个问题，<br/>在 MySQL 5.7 数据库里，InnoDB引擎，执行⼀条DDL会发生什么事情？<br/>举个例子，表记录数 400W+，表字段数 20+，索引4个，数据大小 1.7G，配置4核16G，主从复制，读写分离。<br/>
![Desktop View](/assets/images/20241208/onlineddl_table_count.jpg){: width="500" height="300" }
_MySQL table count统计_
![Desktop View](/assets/images/20241208/onlineddl_mysql_table_fields.jpg){: width="500" height="300" }
_MySQL table 字段统计_
![Desktop View](/assets/images/20241208/onlineddl_mysql_table_indexes.jpg){: width="500" height="300" }
_MySQL table 索引统计_
...
![Desktop View](/assets/images/20241208/onlineddl_support_column_operations.jpg){: width="500" height="300" }
...
![Desktop View](/assets/images/20241208/onlineddl_mysql_prepare_alter_commit.jpg){: width="750" height="450" }
...
![Desktop View](/assets/images/20241208/onlineddl_mysql_phases.jpg){: width="500" height="300" }
_onlineddl_case_phases_

**系统资源使用情况**

![Desktop View](/assets/images/20241208/onlineddl_mysql_cpu_quota.jpg){: width="500" height="300" }
_cpu quota_

![Desktop View](/assets/images/20241208/onlineddl_mysql_disk_quota.jpg){: width="500" height="300" }
_disk quota_

![Desktop View](/assets/images/20241208/onlineddl_mysql_disk_tmp_table_quota.jpg){: width="500" height="300" }
