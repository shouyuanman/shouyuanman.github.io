...
![Desktop View](/assets/images/20250615/bert_arch.png){: width="500" height="300" }
...
![Desktop View](/assets/images/20250615/bert_small.png){: width="500" height="300" }
...
![Desktop View](/assets/images/20250615/bert_input.png){: width="500" height="300" }
...
![Desktop View](/assets/images/20250615/bert_vector.png){: width="500" height="300" }
...
![Desktop View](/assets/images/20250615/bert_mlm.png){: width="500" height="300" }
_BERT MLM（图片来自网络）_
...
![Desktop View](/assets/images/20250615/bert_nsp.png){: width="500" height="300" }
_BERT NSP（图片来自网络）_

### **预训练模型-网络拓扑**
论文中，模型同时使用`MLM`和`NSP`进行训练，以最小化两种策略的综合损失函数。

![Desktop View](/assets/images/20250615/bert_model.png){: width="500" height="300" }
