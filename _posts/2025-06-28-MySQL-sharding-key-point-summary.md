...
![Desktop View](/assets/images/20250628/B+_tree.png){: width="800" height="600" }
_B+树结构示意图（图片来自网络）_
...
![Desktop View](/assets/images/20250628/B_tree.png){: width="800" height="600" }
_B树结构示意图（图片来自网络）_
...
![Desktop View](/assets/images/20250628/sharding_key_select.png){: width="400" height="200" }
_怎么选择分片键_
...
![Desktop View](/assets/images/20250628/sharding_query_type.png){: width="400" height="200" }
_sharding查询类型_
...
![Desktop View](/assets/images/20250628/sharding_non_diff_repo_relation.png){: width="400" height="200" }
_sharding非跨库关联查询_
...
![Desktop View](/assets/images/20250628/gene.png){: width="400" height="200" }
_基因法_
{: .prompt-tip }
