...
![Desktop View](/assets/images/20250712/fine_tuning_adapter.png){: width="500" height="350" }
_Adapter Tuning结构（图片来自论文）_

实验结果显示，`Adapter`只用了`1%+`的参数量，就调出了非常好的效果。

![Desktop View](/assets/images/20250712/fine_tuning_adapter_result.png){: width="600" height="500" }
...
![Desktop View](/assets/images/20250712/fine_tuning_prefix.png){: width="500" height="300" }
...
![Desktop View](/assets/images/20250712/fine_tuning_prompt.png){: width="500" height="300" }
...
- 红色是目标单词`[MASK]`，
- 橙色区域是提示词。
![Desktop View](/assets/images/20250712/fine_tuning_p_tuning.png){: width="800" height="400" }
_P-Tuning（图片来自论文）_
{: .prompt-tip }
...
![Desktop View](/assets/images/20250712/fine_tuning_p_tuning_v2_result.png){: width="500" height="300" }
...
![Desktop View](/assets/images/20250712/fine_tuning_p_tuning_v2.png){: width="800" height="400" }
...
![Desktop View](/assets/images/20250712/fine_tuning_lora.png){: width="200" height="100" }
_LoRA（图片来自论文）_
...
![Desktop View](/assets/images/20250712/fine_tuning_lora_math_formula.png){: width="300" height="200" }
_LoRA公式（图片来自论文）_
...
![Desktop View](/assets/images/20250712/fine_tuning_lora_weight_r_result.png){: width="600" height="400" }
...
![Desktop View](/assets/images/20250712/fine_tuning_lora_weight_r_result_2.png){: width="600" height="400" }
_LoRA结果比对（图片来自论文）_
...
![Desktop View](/assets/images/20250712/fine_tuning_lora_weight_r_result_3.png){: width="600" height="400" }
_LoRA结果比对（图片来自论文）_
...
![Desktop View](/assets/images/20250712/fine_tuning_adalora_w_layers.png){: width="600" height="400" }
_AdaLoRA（图片来自论文）_
...
![Desktop View](/assets/images/20250712/fine_tuning_adalora_math_formula.png){: width="400" height="400" }
_AdaLoRA公式（图片来自网络）_
...
![Desktop View](/assets/images/20250712/fine_tuning_adalora_penalty_formula.png){: width="500" height="200" }
...
![Desktop View](/assets/images/20250712/fine_tuning_adalora_feature_importance_model.png){: width="600" height="400" }
...
![Desktop View](/assets/images/20250712/fine_tuning_adalora_formula_overview.png){: width="600" height="400" }
...
![Desktop View](/assets/images/20250712/fine_tuning_qlora.png){: width="600" height="400" }
_QLoRA（图片来自论文）_
...
![Desktop View](/assets/images/20250712/fine_tuning_qlora_nf4.png){: width="600" height="400" }
_QLoRA NF4（图片来自网络）_
...
![Desktop View](/assets/images/20250712/fine_tuning_qlora_nfk_detail.png){: width="600" height="400" }
...
![Desktop View](/assets/images/20250712/fine_tuning_qlora_double_dequant.png){: width="600" height="400" }
...
![Desktop View](/assets/images/20250712/peft_category.png){: width="600" height="400" }
...
![Desktop View](/assets/images/20250712/fine_tuning_unipelt.png){: width="300" height="200" }
_UNIPELT（图片来自论文）_
...
![Desktop View](/assets/images/20250712/fine_tuning_ia3.png){: width="600" height="400" }
_IA3（图片来自论文）_
